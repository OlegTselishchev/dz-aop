...
@Slf4j
@Service
public class TrackTimeServiceAsync extends AbstractTrackTimeService {

    public TrackTimeServiceAsync(TrackTimeStatisticRepository trackTimeRepository) {
    ...
    public void trackTime(long startTimestamp, String methodName) {
        ...
        CompletableFuture.runAsync(() -> {
            logAndSaveResultDuration(result, methodName, true);
        });
    }
}
